...
Always strictly follow SOLID principals and overall clean coding practices.
Always use tabs or 4 spaces to indent. NEVER indent with 2 spaces.
...
- loops and if statements nested more than 2 levels deep

## Dot's Tools

Follow guidelines at /src/tools/TOOLS_GUIDELINES.md
