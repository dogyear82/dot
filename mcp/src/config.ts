import { NewsSettings } from "./tools/services/newsService.js";
import { WeatherSettings } from "./tools/services/weatherService.js";
...
export const loadSettings = (): Settings => ({
    ...
    weather: {
        searchLimit: parseInteger(process.env.DOT_MCP_WEATHER_SEARCH_LIMIT, 5),
