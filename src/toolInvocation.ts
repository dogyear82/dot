...
export function buildToolInferencePrompt(
  ...
  return [
    ...
    "- world.lookup: query",
    "Use weather.lookup for weather questions. On the first turn, args.location is fine for a city and state or city and country. On clarification follow-ups, prefer structured args.city, args.admin1, and args.country when the owner supplies them.",
    ...
    '{"decision":"execute_tool","toolName":"weather.lookup","reason":"owner supplied the city, state, and country after a weather clarification","confidence":"high","args":{"city":"San Gabriel","admin1":"California","country":"United States"}}',
    ...
    '- execute_tool weather clarification follow-up: {"decision":"execute_tool","toolName":"weather.lookup","reason":"owner clarified the weather location","confidence":"high","args":{"city":"San Gabriel","admin1":"California","country":"United States"}}',
...
export function buildAddressedToolInferencePrompt(
  ...
  return [
    ...
    "- Use weather.lookup when the user wants current weather or a forecast. If the latest message is clarifying a previously ambiguous weather location, prefer structured args.city, args.admin1, and args.country when available.",
    ...
    'Latest message: "San Gabriel California"',
    '{"addressed":true,"decision":"execute_tool","toolName":"weather.lookup","reason":"the user is clarifying the weather location","confidence":"high","args":{"city":"San Gabriel","admin1":"California","country":"United States"}}',
